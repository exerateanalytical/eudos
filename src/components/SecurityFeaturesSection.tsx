            ...
            {securityFeatures.map((feature) => {
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-lg border border-border/50 bg-card hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 group cursor-pointer active:scale-95 whitespace-nowrap"
                >
