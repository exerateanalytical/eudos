        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">
              350+ Top Universities & Colleges
            </h1>
            <p className="text-lg text-muted-foreground mb-8">
              Premium authentic diplomas from North America's most prestigious institutions. 
              100+ top American universities, 100 Canadian universities, 75+ Canadian colleges, and 100 top American community colleges.
