...
const DriverLicenseDetail = () => {
  ...
  const licenseData = {
    ...
    description: `Premium ${country} driver's license with advanced polycarbonate card stock and integrated security features. Includes biometric photo, ghost image technology, microtext printing, UV-reactive ink, laser engraving, barcode/magnetic stripe, and holographic overlays. Tamper-evident design with exceptional durability. Passes all authentication checks. Processing in 5-7 business days with secure worldwide shipping and quality inspection.`,
